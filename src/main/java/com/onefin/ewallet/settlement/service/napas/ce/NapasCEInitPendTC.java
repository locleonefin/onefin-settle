...
public class NapasCEInitPendTC extends QuartzJobBean {

    private static final Logger LOGGER = LoggerFactory.getLogger(NapasCEInitPendTC.class);
    ...
    protected void executeInternal(JobExecutionContext context) throws JobExecutionException {
        ...
        LOGGER.info("{} Start Create Pending Trans {}", LOG_NAPAS_CE_PREFIX, currentDate);
        SettlementTransaction trans = settleRepo.findByPartnerAndDomainAndSettleDate(SettleConstants.PARTNER_NAPAS,
                SettleConstants.LINK_BANK, currentDate);
        if (trans == null) {
            try {
                ...
                LOGGER.info("{} Created Pending Trans Successfully {}", LOG_NAPAS_CE_PREFIX, currentDate);
            } catch (Exception e) {
