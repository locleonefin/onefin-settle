...
public class NapasWL1ProcessXL extends QuartzJobBean {

	private static final Logger LOGGER = LoggerFactory.getLogger(NapasWL1ProcessXL.class);

	private static final String LOG_NAPAS_PG_PREFIX = SettleConstants.PARTNER_NAPAS + " " + SettleConstants.PAYMENT_GATEWAYWL1;

	private static final String NAPAS_PG_ISSUE_SUBJECT_XL = "[Napas - WL1] - Settle XL error";

	private static final String NAPAS_PG_SUBJECT_XL = "[Napas - WL1] - Settle XL dispute";
	...
	protected void executeInternal(JobExecutionContext context) throws JobExecutionException {
		...
		List<SettlementTransaction> transPendXLs = settleRepo
				.findAllByPartnerAndDomainAndStatusTransaction(SettleConstants.PARTNER_NAPAS, SettleConstants.PAYMENT_GATEWAYWL1, SettleConstants.SETTLEMENT_PENDING_T1);
		...
		if (transPendXLs.size() == 0) {
			...
			jobTmp.setJobClass(NapasWL1ProcessXL.class.getName());
...
//			}
			...
			LOGGER.error("{} Decrypt Error {} {} {} ", LOG_NAPAS_PG_PREFIX, napasEncode, diffDay, e);
		}
	}
