...
public class NapasWL2ProcessXL extends QuartzJobBean {

	private static final Logger LOGGER = LoggerFactory.getLogger(NapasWL2ProcessXL.class);
	...
	protected void executeInternal(JobExecutionContext context) throws JobExecutionException {
		...
		List<SettlementTransaction> transPendXLs = settleRepo
				.findAllByPartnerAndDomainAndStatusTransaction(SettleConstants.PARTNER_NAPAS, SettleConstants.PAYMENT_GATEWAYWL2, SettleConstants.SETTLEMENT_PENDING_T1);
		...
		if (transPendXLs.size() == 0) {
			...
			jobTmp.setJobClass(NapasWL2ProcessXL.class.getName());
